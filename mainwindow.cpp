...
void MainWindow::on_pushButton_clicked()
{
    QMessageBox aboutDlg(this);
     ...
     aboutDlg.setText(tr("<br>Автор: Билевич Анастасия Вячеславовна"
                         "<br>Группа: КИ19-09Б"
                         "<br>Добро пожаловать!"
                         "Табло авиарейсов – это приложение, которое несет информационный характер о рейсах и подобна онлайн-табло в реальных аэропортах. "
                         "Данная система позволяет получать актуальную информацию о рейсах всем пользователям и позволяет вносить изменения как в список пользователей, "
                         "так и в список рейсов для отдельных групп пользователей. "
                         "Чтобы изменить статус или личные данные, обратитесь к администратору."));
      aboutDlg.exec();
}
